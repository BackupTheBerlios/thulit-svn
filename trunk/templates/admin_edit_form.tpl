...
<div class="admin_edit_form form">
    <form method="post" action="admin.php?edit_id={$edit_form_data.id}&action=edit_node">
        <ul class="list">
            ...
            <li class="list_item tpl_name"><div class="label">class:</div>
                <div class="value">
                    <input class="input_text" name="class" type="text" value="{$edit_form_data.class}" /></div></li>
            <li class="list_item tpl_name"><div class="label">view_level:</div>
                <div class="value">
                    <input class="input_text" name="view_level" type="text" value="{$edit_form_data.view_level}" /></div></li>
            <li class="list_item tpl_name"><div class="label">edit_level:</div>
                <div class="value">
                    <input class="input_text" name="edit_level" type="text" value="{$edit_form_data.edit_level}" /></div></li>
{if $edit_form_data.node_type eq 'value' or $edit_form_data.node_type eq ''}
            <li class="list_item data_text"><div class="label">data text:</div>
                <div class="value">
{* oFCKeditor->Create *}
<textarea class="input_text" name="data_text">{$edit_form_data.data_text|htmlentities}</textarea>
                </div></li>
